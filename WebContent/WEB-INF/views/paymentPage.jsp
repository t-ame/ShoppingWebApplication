							...
							<div class="col-md-12">
								<form action="./pay" method="post">
									<div class="form-group row">
										...
										<div class="col-8">
											<input id="email" name="cardNumber" placeholder="Card number"
												class="form-control here" required="required" type="number">
										</div>
									</div>
									<div class="form-group row">
										<label for="firstName" class="col-4 col-form-label"><tag:message code="expiration"></tag:message></label>
										<div class="col-8">
											<input id="name" name="expiration" placeholder="MM/YY"
												class="form-control here" type="text"
												required>
										</div>
									</div>
									<div class="form-group row">
										<label for="lastname" class="col-4 col-form-label">CVV</label>
										<div class="col-8">
											<input id="lastname" name="lastName" placeholder="cvv"
									...
									<fieldset>
										...
										<div class="col-md-12">
											<h4><tag:message code="shippingAddress"></tag:message></h4>
											<hr>
										</div>
